    ...
    <div class="container">
      ...
      <form method="post" action="<?php echo ROOTPATH;?>index.php?controller=user&action=update&id=<?php echo $user['user_id'];?>">
        <center><h1> Edit user details</h1></center><br><br>
          ...
          <h3>Password</h3>
          <div class="row">
            <div class="col-md-12"> <input type="text" class="form-control" name="password" placeholder="Password" value="<?php echo $user['password'];?>"><br></div>
          </div>
          ...
          <p style="font-size: 14px;">0 = Administrator, 1 = User can post snippets, 2 = User cannot post snippets</p>
          <div class="row">
