...
class UserController{
                ...
                if(empty(trim($username))){
                    ...
                    try{
                        ...
                        if(!empty($userData)){
                            ...
                            $_SESSION['session_hash'] = genSessionHash();
    ...
    public function update(){
        ...
        //User must either be an admin or can only update their own information
        if(!isAdmin() && intval($_GET['id']) != intval($_SESSION['user_id'])){
            $err = "Invalid access";
            header('Location:' . ROOTPATH . 'index.php?controller=pages&action=error&err=' . $err);
            die();
        }
